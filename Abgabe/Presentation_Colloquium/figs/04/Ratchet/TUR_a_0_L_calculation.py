...
np.savetxt("i_0_vals.txt", i_0_vals)
...
for i in range(len(D_vals)):
    ...
    for j in range(len(Uncertainty_product_vals)): 
        Uncertainty_product_vals[j] = Uncertainty_Product_Ratchet_a_0(i_0 = i_0_vals[j], D = D_vals[i])
        Conjecture_vals[j] = Conjecture_Ratchet_a_0(i_0 = i_0_vals[j], D = D_vals[i])
    ...
    np.savetxt(filename, Uncertainty_product_vals)

    filename = "Conjecture_a_0_" + str(D_vals[i]) + ".txt"
    np.savetxt(filename, Conjecture_vals)
...
#     for j in range(len(Uncertainty_product_vals)): 
#         Uncertainty_product_vals[j] = Uncertainty_Product_Ratchet_a_L(i_0 = i_0_vals[j], D = D_vals[i])
#         Conjecture_vals[j] = Conjecture_Ratchet_a_L(i_0 = i_0_vals[j], D = D_vals[i])
