...
from Exact_Solutions import  Uncertainty_Product_Ratchet_a_0, Conjecture_Ratchet_a_0
...
Exact_Solutions.a = Exact_Solutions.L*0
...
plt.savefig('TUR_Ratchet_a_0.pdf')
plt.show()
