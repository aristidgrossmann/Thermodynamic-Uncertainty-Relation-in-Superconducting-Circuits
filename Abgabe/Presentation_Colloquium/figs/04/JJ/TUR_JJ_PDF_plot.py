...
for i in range(len(D_vals)):
    ...
    axs[1].plot(phi_vals, PDF_minus, linestyle = '-',label = D_labels[i], color = colors[i], zorder = 1)
...
axs[0].text(0.15, 0.9, r'$U_{-}$', transform=axs[0].transAxes,
         fontsize=11, va='top', ha='left')

axs[0].text(0.9, 0.9, r'$U_{+}$', transform=axs[0].transAxes,
         fontsize=11, va='top', ha='left')


axs[1].text(0.29, 0.65, r'$\tilde{J}_{-}$', transform=axs[1].transAxes,
         fontsize=11, va='top', ha='left')

axs[1].text(0.67, 0.65, r'$\tilde{J}_{+}$', transform=axs[1].transAxes,
         fontsize=11, va='top', ha='left')
