...
os.chdir('C:/Users/arist/Desktop/SS25/BA/Code/Cases/JJ_R_Circuit_with_Noise/IV_Curve_Noise_ratio_1')
...
ax.set_title(r'I-V curve for $\sqrt{\frac{2 k_{\mathrm{B}}T}{E_{\mathrm{J}}}} = 1$')
...
plt.tight_layout()
plt.savefig('JJ_R_Circuit_Noise_IV_ratio_1.pdf')
plt.show()
