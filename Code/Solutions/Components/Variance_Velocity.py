...
from Exact_Solutions import L, Variance_Velocity
...
for i in range(len(D_vals)):
    ...
    for j in range(len(Variance_vals)):
        Variance_vals[j] = Variance_Velocity(i_0 = i_0_vals[j], D = D_vals[i])
...
ax.scatter(i_0_numerical, Numerical_variance_velocitites_D_0_1, marker = 'x' , s = 25, label=D_labels[0] + ' numerical', color = 'red')
ax.scatter(i_0_numerical, Numerical_variance_velocitites_D_0_5, marker = '+' , s = 50, label=D_labels[1] + ' numerical', color = 'red')
ax.scatter(i_0_numerical, Numerical_variance_velocitites_D_1,  marker = '^' , s = 25, label=D_labels[2] + ' numerical', color = 'red')
ax.scatter(i_0_numerical, Numerical_variance_velocitites_D_2, marker = 'o' , s = 25, label=D_labels[3] + ' numerical', color = 'red')
ax.scatter(i_0_numerical, Numerical_variance_velocitites_D_5, marker = '<' , s = 25, label=D_labels[4] + ' numerical', color = 'red')
ax.scatter(i_0_numerical, Numerical_variance_velocitites_D_10, marker = '>' , s = 25, label=D_labels[5] + ' numerical', color = 'red')
...
plt.savefig('Variance_Velocity.pdf')
plt.show()
